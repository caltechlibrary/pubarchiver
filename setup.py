...
# =============================================================================
# @file    setup.py
# @brief   Microarchiver setup file
...
# The following reads the variables without doing an "import microarchiver",
...
version = {}
with open(path.join(here, 'microarchiver/__version__.py')) as f:
...
setup(
    ...
    keywords         = "journal archiving dark-archive Portico micropublications",
    packages         = ['microarchiver'],
    scripts          = ['bin/microarchiver'],
